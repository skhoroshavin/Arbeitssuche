export function ResumeClassicPreview() {
  return (
    <svg viewBox="0 0 120 170" className="w-full h-full">
      ...
      <line x1="10" y1="30" x2="110" y2="30" stroke="#999" strokeWidth="0.5" />
      <rect x="10" y="36" width="45" height="4" rx="0.5" fill="#6b7280" />
      <line x1="10" y1="42" x2="110" y2="42" stroke="#999" strokeWidth="0.3" />
      ...
      <line x1="10" y1="92" x2="110" y2="92" stroke="#999" strokeWidth="0.3" />
