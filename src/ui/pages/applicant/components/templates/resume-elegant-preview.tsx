export function ResumeElegantPreview() {
  return (
    <svg viewBox="0 0 120 170" className="w-full h-full">
      ...
      <line x1="10" y1="28" x2="110" y2="28" stroke="#3d3d3d" strokeWidth="1" />
      <rect x="38" y="32" width="44" height="3" rx="0.5" fill="#ccc" />
      <line x1="10" y1="38" x2="110" y2="38" stroke="#ccc" strokeWidth="0.3" />
      ...
      <line x1="32" y1="96" x2="32" y2="112" stroke="#ddd" strokeWidth="0.5" />
